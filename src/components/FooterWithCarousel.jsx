...
/>
            ...
            <div className="flex flex-col space-y-2">
              ...
              <ul className="space-y-3">
                <li>
                  <a href={links[0]?.fb} className="flex items-center space-x-2 hover:text-white transition-colors duration-200">
                    <FaFacebookF />
                    <span>Facebook</span>
                  </a>
                </li>
                ...
                <li>
                  <a href={links[0]?.insta} className="flex items-center space-x-2 hover:text-white transition-colors duration-200">
                    <FaInstagram />
                    <span>Instagram</span>
                  </a>
                </li>
                <li>
                  <a href={links[0]?.youtube} className="flex items-center space-x-2 hover:text-white transition-colors duration-200">
                    <FaYoutube />
                    <span>You Tube</span>
                  </a>
                </li>
            ...
            <div className="flex flex-col space-y-2">
              ...
              <p>Address: <a href="mailto:info@urbancompany.com" className="hover:text-white transition-colors duration-200">{links[0]?.address}</a></p>
              <p>Email: <a href="mailto:info@urbancompany.com" className="hover:text-white transition-colors duration-200">{links[0]?.email}</a></p>
              <p>Phone: <a href="tel:+1234567890" className="hover:text-white transition-colors duration-200">{links[0]?.phone}</a></p>
            </div>
          </div>
        </div>
      </div>
