...
const DetailedServiceCard = ({ service, userLocation, vendor }) => {
    ...
    <div className="detailed-card">
      <div className="image-container">
        ...
        <div className="frosted-overlay">
          <button className="book-now-btn" onClick={handleViewDetails}>
            <FaTicketAlt className="btn-icon" /> View Details
          </button>
        </div>
      </div>
        ...
        <div className="meta-left">
          <div className="rating-duration">
            <div className="service-header">
              <h3 className="service-title" style={{ color: "white" }}>
                {service.title}
              </h3>
              <p className="service-description" style={{ color: "white" }}>
                {service.description}
              </p>
            </div>
            <span
              className="rating"
              style={{ color: "white", alignItems: "start" }}
            >
