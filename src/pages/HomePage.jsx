...
import { fetchSocialLinks,fetchProdDataDESC, fetchImages, } from '../API';
...
const fetchSliderImages=async()=>{
 const Data= await fetchImages();
    HeroBannerSliderImage.length = 0;
 
    HeroBannerSliderImage.push(...(Data));
    localStorage.setItem("urbanAuraServicesSliderImage", JSON.stringify(HeroBannerSliderImage));
}
 useEffect(() => {
fetchSliderImages();
    getLinks();
