    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="relative w-[100%] h-[92vh] mt-10 m-2 bg-white rounded-2xl shadow-2xl overflow-hidden animate-fadeIn flex flex-col">
            {/* Header */}
                ...
                history.map((order) => (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center mb-3">
                      <div>
                         <p className="text-xs text-black">Order Id: {order.order_id}</p>
...
Product Purchase Id
                                ...
                                <td className="py-1">{itm.
product_purchase_id}</td>
                              </tr>
                            </tbody>
                          </table>
                        </div>
